...
>
    <p class="text-md sm:text-xl mb-4">
    ...
    <ul class="text-sm sm:text-base list-disc pl-4 sm:pl-8">
        <li>
            Led a two-person team to develop a housing price prediction model
            with Java on CSV datasets
        </li>
        <li>
            Implemented ordinary linear regression to predict prices based on
    ...
    <ul class="text-sm sm:text-base list-disc pl-4 sm:pl-8 mb-4 sm:mb-8">
        <li>
            Developed a multi-language grammar checking library with spaCy to
            build real-time grammar checkers with dependency parsing.
        </li>
        <li>
        ...
        <li>
            ...
            dependency parser (93% LAS) and POS tagger (98% accuracy), checking
            for 20+ grammar errors with 83% accuracy.
        </li>
        <li>
    ...
    <ul class="text-sm sm:text-base list-disc pl-4 sm:pl-8">
        <li>
            Developed a competitive typing game with React, deployed on Firebase
            Hosting with 120 active users.
        </li>
        <li>
            Leveraged Firebase Cloud Functions written in Node for live
            leaderboard and user profile updates, ensuring consistency between
            clients with sub-150ms latency.
        </li>
        <li>
            Implemented a MySQL database on Google Cloud SQL to manage user data
    ...
    <ul class="text-sm sm:text-base list-disc pl-4 sm:pl-8">
        <li>
            <span class="font-bold">Languages:</span> Python, Java, TypeScript, JavaScript,
            C, SQL
        </li>
        <li>
        ...
        <li>
            <span class="font-bold">ML/DS:</span> NumPy, Pandas, Matplotlib, PyTorch,
            OpenCV, spaCy
        </li>
        <li>
            <span class="font-bold">Tools/Platforms:</span>Git, GCP, AWS EC2,
